...
## 2026-07-18 — PHOMEMO PM-241 SUPPORT: BUILT, SHIPPED ON iOS 1.4, THEN FULLY REMOVED (owner decision)
Isang buong Phomemo PM-241 (PM-241Z-BT) label-printer support system ang binuo
(typography P1–P3.7, in-app BT discovery/pairing, single-Scan merge) at
NA-SHIP sa **iOS 1.4 (live sa App Store)**. **Desisyon ng may-ari (2026-07-18):
hihinto sa PM-241, balik sa AIMO D520BT lang.** Ang LAHAT ng 241 code +
kasamang scan/pairing changes ay **buong-buong tinanggal** sa `main` — ang repo
ay ibinalik sa pre-saga (baseline `c8752c9`) na estado, para bang hindi kailanman
nangyari ang 241 (maliban sa git history).
- **Removal branch:** `claude/remove-241` (file-restoration-to-baseline; AIMO
  byte-parity vs pre-saga verified). Ang buong 241 saga ay nasa git history
  (`c8752c9..95082c7`, 41 commits) kung kailangang balikan.
- ** Retained:** `mobile/build-android-testapk.sh` (generic dev tooling, walang
  241 ref); ang version bump **versionCode 5 / versionName 1.4** (nasa Play
  internal track na — susunod na release ay ≥6).
- **⚠️ Naka-ship na binaries:** ang iOS 1.4 (live) at ang Android APK ni Jeff ay
  may 241 native code pa — gumagana pa rin ang kanilang AIMO flows (ang web ay
