...
// `printRawTspl` = DEV-only raw-TSPL passthrough (print-probe harness). Additive:
// routes through the SAME native BLE/SPP transport as testStickerPrint; production
// sticker path (printStickerNative) is unaffected.
export type BtBridgeAction = "scanBluetoothLabelPrinters" | "getBluetoothLabelPrinter" | "setBluetoothLabelPrinter" | "clearBluetoothLabelPrinter" | "testStickerPrint" | "printStickerNative" | "printRawTspl";
