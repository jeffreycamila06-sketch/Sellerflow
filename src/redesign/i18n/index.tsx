...
const RAW: Record<string, Row> = {
  ...
  rd_lp_price_sub: { en: "Start free with 200 orders per cycle. Pay securely via Wise + Telegram — no credit card needed.", fil: "Magsimula nang libre na may 200 order kada cycle. Magbayad nang ligtas via Wise + Telegram — walang credit card.", zh: "免费开始，每周期 200 个订单。通过 Wise + Telegram 安全付款——无需信用卡。", "zh-TW": "免費開始，每週期 200 筆訂單。透過 Wise + Telegram 安全付款——無需信用卡。", vi: "Bắt đầu miễn phí với 200 đơn mỗi chu kỳ. Thanh toán an toàn qua Wise + Telegram — không cần thẻ tín dụng.", th: "เริ่มฟรีด้วย 200 ออเดอร์ต่อรอบ ชำระเงินอย่างปลอดภัยผ่าน Wise + Telegram — ไม่ต้องใช้บัตรเครดิต", id: "Mulai gratis dengan 200 pesanan per siklus. Bayar aman via Wise + Telegram — tanpa kartu kredit." },
  ...
  rd_lp_price_free_tag: { en: "200 orders per cycle", fil: "200 order kada cycle", zh: "每周期 200 个订单", "zh-TW": "每週期 200 筆訂單", vi: "200 đơn mỗi chu kỳ", th: "200 ออเดอร์ต่อรอบ", id: "200 pesanan per siklus" },
  ...
  rd_lp_pf_1: { en: "200 orders / cycle", fil: "200 order / cycle", zh: "每周期 200 个订单", "zh-TW": "每週期 200 筆訂單", vi: "200 đơn / chu kỳ", th: "200 ออเดอร์ / รอบ", id: "200 pesanan / siklus" },
  ...
  rd_lp_faq_a5: { en: "Yes — 200 orders per cycle, free forever, no card required.", fil: "Oo — 200 order kada cycle, libre habambuhay, walang card na kailangan.", zh: "有——每周期 200 个订单，永久免费，无需信用卡。", "zh-TW": "有——每週期 200 筆訂單，永久免費，無需信用卡。", vi: "Có — 200 đơn mỗi chu kỳ, miễn phí mãi mãi, không cần thẻ.", th: "มี — 200 ออเดอร์ต่อรอบ ฟรีตลอดไป ไม่ต้องใช้บัตร", id: "Ya — 200 pesanan per siklus, gratis selamanya, tanpa kartu." },
