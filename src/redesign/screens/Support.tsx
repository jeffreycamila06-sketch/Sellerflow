    ...
    <div>
      ...
      <div style={{ padding: "16px 14px 22px" }}>
        <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 16, padding: 16, boxShadow: "var(--shadow)", textAlign: "center" }}>
          ...
          <a href="https://t.me/SellerFlowLive1995" target="_blank" rel="noreferrer" style={{ width: "100%", marginTop: 14, padding: "13px 0", border: "none", borderRadius: 12, background: "#0088cc", color: "#fff", fontFamily: "var(--font-ui)", fontSize: 13.5, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, textDecoration: "none" }}>
            ...
            {t.rd_sup_chat} @SellerFlowLive1995
          </a>
        </div>
